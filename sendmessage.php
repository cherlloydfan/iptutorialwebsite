...
if (isset($_POST['send'])) { 
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx','png','jpg','doc','ppt','pptx','txt','xlsx','image/*','mp4'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
            $sql = "INSERT INTO users (username,ticketname,message,sender,recipient,file, filesize, downloads) VALUES ('lucy25','$subject','$message','$sender','$recipient','$filename', $size, 0)";
