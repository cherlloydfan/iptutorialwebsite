...
$stmt = $con->prepare('SELECT projectname,projectdescription,projectchapters,firstname,surname FROM users WHERE id = ?');
...
<tr>
<td><button onclick="finishcourse()" >Finish course</button></td><td> <a href="addproject"><button>Add new project </button></a>
</td> </tr>
