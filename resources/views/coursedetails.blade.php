...
<tr>
  <td><h3>Quiz:</h3></td>
  <td><a href="quiz"><button style="width:100px" >Do quiz</button></a></td>
 

</tr>
<tr>
  <td><h3>Course trial:</h3></td>
  <td><a href="studentsignup"><button style="width:100px" >Start trial</button></a></td>
 

</tr>

<tr><td><h3>Join course:</h3></td><td><form method="post" action="{{url('joincourse')}}"> @csrf <input style="width:100px" type="submit" name="send" id="joincourse" value="Join course"></input></form></td></tr>
