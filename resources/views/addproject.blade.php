...
<form action="{{url('addproject')}}" method="post" >
  ...
  <tr>   <p>
     <td>  <h3><label for="projectname">Project name</label></h3></td><br>
       <td> <input type ="text" name="projectname" min='1' max='100' required></td><br>
        
    </p></tr> 
    <tr>
    <p>
    <td style="display: inline-block; position: relative;margin-top:-6%"><h3> <label for="projectdescription">Project description</label></h3></td> <br>
     <td><textarea name="projectdescription" cols="44" rows="10" id="description" required></textarea></td> <br>
     
  </p></tr>
  <tr>
  <p>
   <td><h3> <label for="projectchapters">Project chapters</h3></td><br>
   <td> <input type="text" name="projectchapters" min='1' max='100' required></td><br>
    
</p></tr>
    
     <tr><td>  <input type="submit" name="send" value="Add project"></td></tr> 
