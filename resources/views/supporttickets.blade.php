...
$stmt = $con->prepare('SELECT ticketname,jobdate,progress,response,assignedto FROM users WHERE id = 24');

$stmt->execute();
$stmt->bind_result($ticketname,$jobdate,$progress,$response,$assignedto);
$stmt->fetch();
$stmt->close();
?>
