...
<div id="headertext">New post</div>
 </div>
</section  >
...
<form action="{{('sendpost')}}" method="post" enctype="multipart/form-data">
  ...
  @csrf
    <div class="container">
<tr>   
     <td> <h3>  <label>Name:</h3></td>
       <td> <input type="text" name="personname" required min="1" max="300"></td>
        
 
    </tr> 
    <tr>   
        <td> <h3>  <label>Post name:</h3></td>
          <td> <input type="text" name ="postname" required min="1" max="300"></td>
           
    
       </tr> 
       <tr>   
        <td style="display: inline-block; position: relative;margin-top:-1%"> <h3>  <label>Post body:</h3></td>
          <td> <textarea  name="postbody" rows='10' required min="1" max="1000"></textarea></td>
       ...
       <tr><td> <h3> <label>Add attachment</label></h3>
           ...
           <tr><td>  <input type="submit" name="send" value="Send post"></td></tr> 
